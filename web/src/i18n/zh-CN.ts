export const zhCN = {
  ...
  layout: {
    ...
    themeDark: "深色模式",
    themeLight: "浅色模式",
    sidebarPreferenceLabel: "侧边栏模式",
    sidebarPreferenceAuto: "自动伸缩",
    sidebarPreferenceCollapsed: "始终折叠",
    sidebarPreferenceExpanded: "始终展开",
    profile: "个人中心",
    settings: "个人设置",
    admin: "管理后台",
    logout: "退出登录",
...
:::`,
  ...
  settings: {
    ...
    guestNoticeTitle: "当前未登录",
    guestNoticeMessage: "登录后可访问账号、自动保存、AI 模型及个人资料等更多设置。",
    guestNoticeLogin: "前往登录",
    ...
    highlighterShow: "显示",
    highlighterHide: "不显示",
    sidebarAutoBehaviorTitle: "侧边栏自动伸缩布局",
    sidebarAutoBehaviorOverlay: "悬浮展开",
    sidebarAutoBehaviorPush: "推开右侧内容",
    sidebarAutoBehaviorDesc: "仅在侧边栏使用“自动伸缩”模式时生效.",
    sectionNavigation: "个人设置栏目",
    sectionAccount: "账号与隐私",
    sectionPreferences: "答题与界面",
    sectionAi: "AI 服务",
    ...
    personalExportNext: "下次可导出时间：{time}",
    personalExportButton: "导出并下载",
    personalExportPreparing: "正在生成…",
    accountDeletionTitle: "注销账号",
    accountDeletionDesc: "注销账号后，您的数据不会在短时间内被完全清除。请参阅我们的",
    accountDeletionUnavailable: "目前自助注销功能暂未开放，请 email",
    accountDeletionEnd: "。",
    accountDeletionButton: "注销账号",
    clearCover: "清空背景图",
    save: "保存设置",
    autosave: {
      "30": "30 秒",
