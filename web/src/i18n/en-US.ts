export const enUS = {
  ...
  layout: {
    ...
    themeDark: "Dark",
    themeLight: "Light",
    sidebarPreferenceLabel: "Sidebar mode",
    sidebarPreferenceAuto: "Auto expand",
    sidebarPreferenceCollapsed: "Always collapsed",
    sidebarPreferenceExpanded: "Always expanded",
    profile: "Profile",
    settings: "Settings",
    admin: "Admin",
    logout: "Log out",
...
:::`,
  ...
  settings: {
    ...
    guestNoticeTitle: "You are not signed in",
    guestNoticeMessage: "Sign in to access account, autosave, AI model, and profile settings.",
    guestNoticeLogin: "Sign in",
    ...
    sidebarAutoBehaviorTitle: "Auto sidebar layout",
    sidebarAutoBehaviorOverlay: "Overlay content",
    sidebarAutoBehaviorPush: "Push content aside",
    sidebarAutoBehaviorDesc: "Applies only in Auto expand mode.",
    sectionNavigation: "Personal settings sections",
    sectionAccount: "Account and privacy",
    sectionPreferences: "Answering and interface",
    sectionAi: "AI services",
    ...
    personalExportNext: "Next export available: {time}",
    personalExportButton: "Export and download",
    personalExportPreparing: "Preparing…",
    accountDeletionTitle: "Delete account",
    accountDeletionDesc: "After account deletion, your data will not be completely removed immediately. Please refer to our",
    accountDeletionUnavailable: "Self-service account deletion is not currently available. Please email",
    accountDeletionEnd: ".",
  ...
  admin: {
    ...
    users: {
      ...
      admin: "Admin",
      bannedLabel: "Banned",
      exportData: "Download personal data",
      exporting: "Preparing",
      exported: "Personal data for {uid} was downloaded.",
      demote: "Demote",
      promote: "Promote",
      unban: "Unban",
      ban: "Ban",
